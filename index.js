...
async function init() {
  ...
  if (
    ...
    !process.argv.some((argument) =>
      ["use", "update"].includes(argument.toLowerCase())
    )
  ) {
    return errorMessage(
  ...
  commands.auth.addCommand(
    new Command("create-custom-token")
      ...
      .addArgument(
        new Argument(
          "<uid>",
          `UID for the token it doesn't have to be a real one.`
        )
      )
      .addArgument(
        new Argument(
  ...
  commands.firestore.addCommand(
    new Command("add-document")
      ...
      .addArgument(
        new Argument("<json/path>", "Stringified JSON or path to file")
      )
  ...
  commands.firestore.addCommand(
    new Command("remove-collection")
      ...
      .addArgument(
        new Argument(
          "[excluded]",
          "A comma seperated list of IDs that should be excluded"
        )
      )
  ...
  commands.firestore.addCommand(
    new Command("export-collection")
      ...
      .addArgument(
        new Argument(
          "[columns]",
          "A comma separated list of columns to return, defaults to *"
        )
      )
      ...
      .addArgument(
        new Argument("[limit]", "Limit number of returned documents")
      )
  ...
  commands.firestore.addCommand(
    new Command("import-collection")
      ...
      .addArgument(
        new Argument(
          "[merge]",
          "When true documents with an id are merged with existing documents with the same id. Otherwise they override the existing ones."
        )
          .default(false)
          .argParser((v) => v === "true")
      )
  ...
  commands.firestore.addCommand(
    new Command("duplicate-document")
      ...
      .addArgument(
        new Argument(
          "<destination>",
          "Can point to a document or collection. If it points to a collection a new document is created."
        )
      )
  ...
  commands.firestore.addCommand(
    new Command("get-document")
      ...
      .addArgument(
        new Argument(
          "<output>",
          "Location on file system to store the document."
        )
      )
  ...
  commands.storage.addCommand(
    new Command("export")
      ...
      .addArgument(
        new Argument(
          "[directory]",
          "When defined starts crawling from the specified prefix."
        )
      )
      .addArgument(
        new Argument("[bucket]", "Name of the bucket to use").default(
          `${config.get("project")}.appspot.com`
        )
      )
      .action(storage.exp)
  );
  ...
  commands.storage.addCommand(
    new Command("import")
      ...
      .addArgument(
        new Argument("[folder]", "Folder to start crawling").default(`/`)
      )
      .addArgument(
        new Argument("[bucket]", "Name of the bucket to use").default(
          `${config.get("project")}.appspot.com`
